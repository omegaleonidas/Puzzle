...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadDataToViews() {
        ...
        for (int i = 0; i < group.getChildCount() - 1; i++) {
            ...
            buttons[i / 4][i %4].setBackgroundResource(R.drawable.ic_launcher_background);
        }

        buttons[emptyX][emptyY].setText("");
        buttons[emptyX][emptyY].setBackgroundColor(ContextCompat.getColor(this, R.color.design_default_color_primary));


    }

    private void generatesNumber() {
        int n = 15;
    ...
    public void buttonClick(View view) {
        ...
        if ((Math.abs(emptyX - x) == 1 && emptyY == y)||(Math.abs(emptyY - y) == 1 && emptyX == x)){
            ...
            buttons[emptyX][emptyY].setBackgroundResource(R.drawable.ic_launcher_background);
            button.setText("");
